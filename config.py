...
BOT_USERNAME = os.getenv("BOT_USERNAME", "@thispersonisbrand537")
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "@thispersonisbrandcardchecker_bot")
...
GATEWAYS = {
    "stripe": {
        ...
        "emoji": "💳",
        "color": "blue",
        "description": "Shopify uses Stripe for payments"
    },
    "braintree": {
        "name": "Braintree (PayPal)",
        "emoji": "🅱️",
        "color": "orange",
        "description": "PayPal Braintree payment gateway"
    },
    "checkout": {
        "name": "Checkout.com",
        "emoji": "🔵",
        "color": "cyan",
        "description": "Checkout.com payment processor"
    },
    "bin_check": {
        "name": "BIN Lookup",
        "emoji": "🔍",
        "color": "green",
        "description": "BIN database lookup only"
    }
}
...
# ==================== Checkout.com API ====================
CHECKOUT_API = "https://api.checkout.com/validate"
